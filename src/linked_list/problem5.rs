...
mod tests {
    ...
    fn test_count_students() {
        ...
        assert_eq!(count_students(vec![1,1,1,0,1,1], vec![1,0,0,0,1,1]), 4);
        assert_eq!(count_students(vec![0,0,0,0,0,0,0], vec![1,1,1,1,1,1,1]), 7);
        assert_eq!(count_students(vec![1,1,1,1], vec![1,1,1,1]), 0);
    }
}
